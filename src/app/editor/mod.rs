...
pub struct Editor<'app> {
    /// Current value of the input box
    pub input: TextArea<'app>,
...
impl<'app> Default for Editor<'app> {
    fn default() -> Editor<'app> {
...
impl Editor<'_> {
    ...
    pub fn load_file(&mut self, file: File) -> Result<()> {
        ...
        // let contents = buf.lines().collect();
