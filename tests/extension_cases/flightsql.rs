...
pub async fn test_invalid_sql_command() {
    ...
    // arrow-flight surfaces server-side failures as a Tonic status; the real
    // FlightSQL service maps SQL parse failures to an internal error
    let expected = r##"error parsing SQL query"##;
